...
class AffiliateWP_Activation {
    ...
    public function missing_affiliatewp_notice() {
        ...
        if ( $this->has_affiliatewp ) {
           echo '<div class="error"><p>' .  $this->plugin_name . ' ' . sprintf( __( 'requires %s. Please activate it to continue.', 'affiliatewp-sign-up-bonus' ), '<a href="http://affiliatewp.com/" target="_blank">AffiliateWP</a>' ) . '</p></div>';

        } else {
            echo '<div class="error"><p>' . $this->plugin_name . ' ' . sprintf( __( 'requires %s. Please install it to continue.', 'affiliatewp-sign-up-bonus' ), '<a href="http://affiliatewp.com/" target="_blank">AffiliateWP</a>' ) . '</p></div>';
        }
    }
}
